const faqs = [
  {
    question: "Can I still use UIP Control alongside my current email client?",
    answer:
      "Yes! UIP Control is intended to be used alongside your existing email client.",
  },
  {
  ...
  {
    question: "Which email providers does UIP Control support?",
    answer:
